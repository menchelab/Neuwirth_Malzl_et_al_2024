...
tregs.tissue.scps <- scanpy_export_to_seurat(
  ...
  '../diffexp/tregs.tissue.tregs.obs.tsv',
  '../diffexp/tregs.tissue.tregs.var.tsv'
)
...
write.de.results(tregs.tissue.scps.de.genes, '../diffexp/tregs.tissue.scps.de.all.tsv', TRUE)
write.de.results(tregs.tissue.scps.sat1.de.genes, '../diffexp/tregs.tissue.scps.sat1.de.all.tsv', TRUE)
write.de.results(tregs.tissue.uc.de.genes, '../diffexp/tregs.tissue.uc.de.all.tsv', TRUE)
write.de.results(tregs.tissue.ad.de.genes, '../diffexp/tregs.tissue.ad.de.all.tsv', TRUE)
